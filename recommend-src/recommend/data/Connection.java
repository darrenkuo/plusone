...
public class Connection implements Serializable {
	...
	static String rpUseragent = "Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US; rv:1.9.2.8) Gecko/20100722 Firefox/3.6.8";
	...
	public Connection( Connection conn ) {
		this( conn.domain, conn.cookies, conn.referer );
	}
